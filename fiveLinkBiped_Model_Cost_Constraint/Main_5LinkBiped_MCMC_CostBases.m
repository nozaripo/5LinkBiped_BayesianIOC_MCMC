...
data_sol = load('Simulated_Speeds_.2dq.u+.5du^2+.3d3q^2.mat'); % 3 Cost components

data_sol = load('Simulated_Speeds_5Bases.mat'); % Cost bases
n_params = length(data_sol.W);
