...
plot(x(1:2),y(1:2),'LineWidth',4,'Color',[1 0 1]);
plot(x(2:3),y(2:3),'LineWidth',4,'Color',[1 0 0]);
plot(x(3:4),y(3:4),'LineWidth',4,'Color',[.3 .3 .3]);
plot(x([3,5]),y([3,5]),'LineWidth',4,'Color',[0 0 1]);
plot(x(5:6),y(5:6),'LineWidth',4,'Color',[0 1 1]);
% ax = gca;
