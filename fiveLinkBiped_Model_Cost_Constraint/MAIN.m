...
problem.bounds.initialstate.low = [[.1  ; .2 ; -.01 ; -.40 ; -.4] ; dqLow];
problem.bounds.initialstate.upp = [[.40 ;.40 ; +.01 ; -.20 ; -.1] ; dqUpp];
...
problem.bounds.control.low(3) = -10;
problem.bounds.control.upp(3) = 10;
