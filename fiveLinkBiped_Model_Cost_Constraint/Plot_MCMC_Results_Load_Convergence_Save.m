...
foldername = '2023-03-13';

foldername = 'Results/2023-04-21';
    ...
    for id_Subj = 1:Num_Subjects
        for id_W= 1:Num_Weights
            ...
            for ii=1:3
                ...
                fullpath = strcat(foldername,FileName_Ext,'/',filename);
                if exist(fullpath) 
                    data = load(fullpath);
...
%             indices = indices(indices>=Num_Sampl_Convergence);
            ...
            chain_tmp = chain_mixed;

            
            chain_Select = [ chain_Select; reshape(chain_tmp,length(chain_tmp)*Num_Costs,1) ];
...
save('Results_BayesianIOC_2023-04-21', 'chain_Select','Cost_ID_Select','True_Weights_Select','Weight_ID_Select','Subject_ID_Select','Inference_ID_Select', 'KS_Stat_Select', 'Median_Dist_Select', 'x_density_Select', 'KS_Stat_Gaus_Select', 'Median_Dist_Gaus_Select', 'KS_Stat_Individual_Select', 'Median_Dist_Individual_Select')
