function [xInt, tInt] = ForwardSimulation_OneSpeed_simple(W, V_treadmill)
...
%parfor i_v=1:length(V_Treadmill_Array)% comment when you would want to run a single optim
...
%%%%% THE KEY LINE:
%soln = optimTraj(problem);
soln = optimTraj1(problem, q0,param, V_treadmill);
