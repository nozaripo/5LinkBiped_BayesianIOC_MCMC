...
% P = P([9,10,7,8,3,4,5,6,1,2],1);
% G = G([9,10,7,8,3,4,5,6,1,2],1);
...
while lim <= 3
    if mod(co,2) == 0
        plot([lim lim+.2]-V_tr*t+ offset ,groundy,'LineWidth',10,'Color',colorGround);hold on;
    else
...
plot(x([3,5]),y([3,5]),'LineWidth',7,'Color',[1 0 0]);
plot(x(5:6),y(5:6),'LineWidth',7,'Color',[1 0 1]);
plot(x(3:4),y(3:4),'LineWidth',8,'Color',[.3 .3 .3]);
plot(x(1:2),y(1:2),'LineWidth',7,'Color',[0 1 1]);
plot(x(2:3),y(2:3),'LineWidth',7,'Color',[0 0 1]);
% ax = gca;
