function [m,mi,f,fi,mz,mzi,mzd,fz,fzi,fzd] = autoGen_dynForward(q1,q2,q3,q4,q5,dq1,dq2,dq3,dq4,dq5,ddq1,ddq2,ddq3,ddq4,ddq5,m1,m2,m3,m4,m5,I1,I2,I3,I4,I5,l1,l2,l3,l4,c1,c2,c3,c4,c5,g,empty)
%AUTOGEN_DYNSS
...
if nargout > 2
    f = [+m5.*t93.*(t21+t22-t60-t61)-g.*m1.*(t21-c1.*t20)-g.*m3.*t45-g.*m4.*t50-g.*m2.*t70-g.*m5.*t69+m4.*t50.*t83+m3.*t45.*t90-m3.*t42.*t95-m4.*t49.*t91-m2.*t74.*t87-m5.*t82.*(t75+t78-c5.*t48.*t81-l4.*t27.*t76)+m2.*t70.*(t77+t72.*(t26-c2.*t23));+m2.*(t77+t72.*t98).*(t22-t71)+g.*m5.*t65-g.*m2.*t85-g.*m3.*t88-g.*m4.*t97-m5.*t65.*t93+m3.*t88.*t90+m4.*t83.*t97-m2.*t87.*t98-m4.*t91.*t92-m3.*t95.*t96+m5.*t64.*(t75+t78-c5.*t48.*t81-l4.*t27.*t76);t105+t106+t107+t108-m5.*t93.*t101-c4.*m4.*t27.*t83+g.*m3.*t19.*t43+m3.*t29.*t43.*(t75+t78-c3.*t19.*t79+l3.*t19.*t79)-m3.*t19.*t43.*(t77+t80-c3.*t29.*t79+l3.*t29.*t79);t105+t106+t107+t108-m5.*t93.*t101-c4.*m4.*t27.*t83;+c5.*g.*m5.*t48+c5.*l1.*m5.*t73.*t109+c5.*l2.*m5.*t72.*t127-c5.*l4.*m5.*t76.*t142];
end
if nargout > 3
