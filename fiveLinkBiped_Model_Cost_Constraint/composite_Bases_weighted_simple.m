function [dObj, dObj_TimeSeries] = composite_Bases_weighted_simple(t,x,u,p, W, scaling, V_tr, loadings, center, scale)
...
Work_Absolute = sum( (u.*dq).*tanh((u.*dq)*10) ) ;
...
% Cost_Vector_scaled = (Cost_Vector - center) ./ scale ;
% Cost_Vector_scaled = (Cost_Vector - center) ./ scale ./ scaling ;
% Cost_Vector_scaled = (Cost_Vector) ./ scale ;
% Cost_Vector_scaled = (Cost_Vector) ./ scaling;

Cost_Vector_scaled = (Cost_Vector) ./ scale ./scaling;
% % % dObj = W * (Cost_Vector_scaled) / t(end);
