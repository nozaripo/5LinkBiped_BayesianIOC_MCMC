function [c, ceq, cGrad, ceqGrad] = pathConstraint_behavioral(t,x,u,q0,p, V_tr)
...
c_q4_init = [q5(1)+.25; q4(1)+.08 ; -q1(1)+.01; -q2(1)+.15];
...
c_torso_treadmill = (G(3,end)-G(3,1)) * tanh( (G(3,end)-G(3,1)) *10 ) - .03;
% c_torso_treadmill = [];
...
c_clearance = -P(10,4)'+.005;
c_clearance = -P(10,5)'+.01;
c_clearance = [];

c_torso_height = -P(4,:)'+.85; % For the torso height be above 85cm the entire time
c_torso_height = -P(4,end) + P(4,1) - .02; % For the end torso height be within the start torso height
c_torso_height = [];
...
c_foot_height_end1 = P(10,end)-.01;
c_foot_height_end1 = [];
c_foot_height_end2 = -P(10,end);
c_foot_height_end2 = [];

c = [c;c_u;c_clearance; c_q4_init; c_foot_foreaft_init; c_torso_treadmill; c_torso_height;
    c_foot_height_end1; c_foot_height_end2];
