function [Behavior_Prediction_Error, solution] = MAIN_ForwardOptimization_Weighted(problem, param, p, Criterion_Index, scaling, num_forward_sim , opt_soln)
...
problem.func.pathObj = @(t,x,u)( composite_objective_weighted(t,x,u,param, W, scaling ) );
